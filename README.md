...
> **[IMAGE PLACEHOLDER]**: Insert a high-level diagram of the CPU–Cache–Memory hierarchy (e.g., from Slide 2 of your presentation).
...
This project serves as a practical exploration of cache architecture in computer systems — from designing a simulator to evaluating real-world replacement policies.
